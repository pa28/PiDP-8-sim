...
enum pseudo_t
{
  ...
  XLIST,   ZBLOCK,  FILENAME, DEVICE,  ASCII,    USING
};
...
SYM_T pseudo[] =
{
  ...
  { PSEUDO, "USING",  USING   },	/* Use prefix for local symbols.          */
...
SYM_T permanent_symbols[] =
{
  ...
  /* Programmable version of the PDP-8/e Real Time Clock                      */
  { FIXED,  "CLSF",   06130   },    /* Clock Set Flags                        */
  { FIXED,  "CLEI",   06131   },    /* Clock Enable Intrrupt                  */
  { FIXED,  "CLDI",   06132   },    /* Clock Disable Interrupt                */
  { FIXED,  "CLSK",   06133   },    /* Clock Skip and Clear on Interrupt      */
  { FIXED,  "CLSC",   06133   },    /* Clock Skip and Clear on Interrupt      */
  { FIXED,  "CLSI",   06134   },    /* Clock set counter interval             */
  { FIXED,  "CLSM",   06135   },    /* Clock set counter multiplier           */
  { FIXED,  "RAND",   06136   },    /* Replace AC with random number          */
  { FIXED,  "CLRF",   06137   },    /* Clock Read and Clear Flags             */
